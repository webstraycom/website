...
## September 2026 – WebStray Authenticator 1.6.6

We’ve given [WebStray Authenticator](/authenticator) a major update, introducing a new visual style, powerful keyboard-driven workflows, improved accessibility, and new capabilities for plugin developers, alongside a wide range of bug fixes and visual refinements across the application.
...
We have completely rewritten [WebStray Starlight](/starlight) from scratch with **Next.js** and **next/og** (powered by **Satori** and **resvg**), delivering up to a **18x performance boost** and significantly lower memory overhead.
...
[View WebStray Starlight Documentation](/docs/starlight)
...
- [Download for Windows](https://github.com/webstraycom/authenticator/releases/latest)

#### Important

**Migration Required**: Due to the fundamental security upgrade, 1.6.2 databases are incompatible with this version.
